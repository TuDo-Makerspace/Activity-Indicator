...
# This file is a script used as a placeholder until the website has
# been fully migrated. It is therefore subject to change.
...
# Parse arguments
parser = argparse.ArgumentParser(description="Updates the activity status on the website")
parser.add_argument("--config_file", "-c", help="Config file", default="website.ini")
...
if response.status_code != 200:
    print("website.py: Request Failed: " + response.text, response)
